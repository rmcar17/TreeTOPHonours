...
def plot_times(data):
    ...
    plt.title("Time to Reconstruct for Known Triples")

    fig.savefig("dcm_random_total_time.pdf", bbox_inches='tight')
    ...
    plt.title("Time per Iteration for Known Triples")

    fig.savefig("dcm_random_iteration_time.pdf", bbox_inches='tight')
